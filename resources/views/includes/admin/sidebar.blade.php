<aside class="sidebar-nav-wrapper">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            {{-- Data Perhitungan --}}
            <li class="nav-item nav-item-has-children">
                <a href="#0" class="{{ (request()->is('admin/calculation*')) ? '' : 'collapsed' }}" data-bs-toggle="collapse" data-bs-target="#ddmenu_5" aria-controls="ddmenu_5" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="icon">
                        <i class="lni lni-layout"></i>
                    </span>
                    <span class="text">Data Perhitungan</span>
                </a>
                <ul id="ddmenu_5" class="collapse {{ (request()->is('admin/calculation*')) ? 'show' : '' }} dropdown-nav">
                    <li>
                        <a href="{{ route('admin.calculation.index') }}" class="{{ (request()->is('admin/calculation')) ? 'active' : '' }}">Daftar Data Perhitungan</a>
                    </li>
                </ul>
            </li>
            {{-- Data Hasil Utilitas Kuantitatif --}}
            <li class="nav-item nav-item-has-children">
                <a href="#0" class="{{ (request()->is('admin/quantitative_utility*')) ? '' : 'collapsed' }}" data-bs-toggle="collapse" data-bs-target="#ddmenu_6" aria-controls="ddmenu_6" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="icon">
                        <i class="lni lni-database"></i>
                    </span>
                    <span class="text">Data Hasil Utilitas Kuantitatif</span>
                </a>
                <ul id="ddmenu_6" class="collapse {{ (request()->is('admin/quantitative_utility*')) ? 'show' : '' }} dropdown-nav">
                    <li>
                        <a href="{{ route('admin.quantitative_utility.index') }}" class="{{ (request()->is('admin/quantitative_utility')) ? 'active' : '' }}">Daftar Data Hasil Utilitas Kuantitatif</a>
                    </li>
                </ul>
            </li>
            {{-- Divider --}}
            ...
            <li class="nav-item nav-item-has-children">
                ...
                <ul id="ddmenu_7" class="collapse {{ (request()->is('admin/user*')) ? 'show' : '' }} dropdown-nav">
                    <li>
